...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#393053]">
    <nav class="bg-[#0C0C0C] border-b border-[#0C0C0C] px-4 py-2.5  fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
          <div class="flex justify-start items-center">
            ...
            <a href="#" class="flex items-center justify-between mr-4">
              ...
              alt="Flowbite Logo"
            />
              <span class="self-center text-2xl font-bold whitespace-nowrap text-white" >Hotels</span>
    ...
    <aside
      class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full  border-r  md:translate-x-0 bg-[#0C0C0C]   "
      aria-label="Sidenav"
      id="drawer-navigation"
    >
      <div class=" py-5 px-3 h-full bg-[#0C0C0C]">
        
        <ul class="space-y-2">
          <li>
            <a
              href="{{route('house.index')}}"
              class="flex items-center p-2 text-base font-medium  rounded-lg text-white hover:bg-[#443C68]  group"
            >
